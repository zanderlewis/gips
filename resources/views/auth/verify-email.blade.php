<x-guest-layout>
    <x-authentication-card>
        ...
        <div class="mb-4 text-sm text-gray-600 dark:text-gray-400">
            {{ __('Before continuing, could you verify your email address by clicking on the link we just emailed to you? This is to confirm you really are human and this email exists. If you didn\'t receive the email, we will gladly send you another.') }}
        </div>
